...
It feels only right to start my first blog post with that iconic line. If you're reading this, welcome to my new corner of the internet! This is a mandatory "About section" as a chance for me to introduce myself .

### Who Am I?

My name is Atul Kamath, and I'm currently a B.E. Computer Science student at Visvesvaraya Technological University (VTU). Like many in this field, I'm driven by a deep curiosity about how things *really* work. Ever since I first started using ubuntu I always wondered what goes into building something like it , that led me to discover more about the linux kernel and since then its always been my intrest to keep trying to find what about the crazy things a particular peice of systems software is capable of doing. 
...
I've spent my entire college journey so far living in a terminal, customizing my environment, and enjoying the freedom and control that the Linux ecosystem provides.
